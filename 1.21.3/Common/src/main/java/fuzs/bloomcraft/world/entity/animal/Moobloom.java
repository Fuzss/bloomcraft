...
public class Moobloom extends Cow implements Shearable, VariantHolder<Holder<FlowerMobVariant>> {
    ...
    public Moobloom(EntityType<? extends Cow> entityType, Level level, ResourceKey<Registry<FlowerMobVariant>> registryKey, EntityDataAccessor<Holder<FlowerMobVariant>> dataType) {

 ...
 */
public class MoobloomBlockStateLayer extends RenderLayer<MoobloomRenderState, CowModel> {

    public MoobloomBlockStateLayer(RenderLayerParent<MoobloomRenderState, CowModel> renderer) {
        super(renderer);
    }

    @Override
    public void submit(PoseStack poseStack, SubmitNodeCollector nodeCollector, int packedLight, MoobloomRenderState state, float yRot, float xRot) {

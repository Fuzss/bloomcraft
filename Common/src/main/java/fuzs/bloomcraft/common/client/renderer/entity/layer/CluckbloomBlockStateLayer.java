package fuzs.bloomcraft.common.client.renderer.entity.layer;
 ...
 */
public class CluckbloomBlockStateLayer extends RenderLayer<CluckbloomRenderState, AdultChickenModel> {

    public CluckbloomBlockStateLayer(RenderLayerParent<CluckbloomRenderState, AdultChickenModel> renderer) {
        super(renderer);
    }

    @Override
    public void submit(PoseStack poseStack, SubmitNodeCollector nodeCollector, int packedLight, CluckbloomRenderState state, float yRot, float xRot) {

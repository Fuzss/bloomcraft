...
public class ModDatapackRegistriesProvider extends AbstractDatapackRegistriesProvider {
    ...
    static void bootstrapMoobloomVariants(BootstrapContext<FlowerMobVariant> context) {
    ...
    static void registerMoobloomVariant(BootstrapContext<FlowerMobVariant> context, ResourceKey<FlowerMobVariant> resourceKey, Block block) {
        context.register(resourceKey, new FlowerMobVariant(ModRegistry.MOOBLOOM_ENTITY_TYPE, resourceKey, block));
    }

    static void bootstrapCluckbloomVariants(BootstrapContext<FlowerMobVariant> context) {
    ...
    static void registerCluckbloomVariant(BootstrapContext<FlowerMobVariant> context, ResourceKey<FlowerMobVariant> resourceKey, Block block) {

...
public class Cluckbloom extends Chicken implements Shearable {
    ...
    protected void defineSynchedData(SynchedEntityData.Builder builder) {
        ...
        Registry<FlowerMobVariant> registry = this.registryAccess()
                .registryOrThrow(ModRegistry.CLUCKBLOOM_VARIANT_REGISTRY_KEY);
    ...
    public SpawnGroupData finalizeSpawn(ServerLevelAccessor level, DifficultyInstance difficulty, MobSpawnType spawnReason, @Nullable SpawnGroupData spawnGroupData) {
        ...
        if (spawnGroupData instanceof FlowerMobVariantUtil.VariantGroupData variantGroupData) {
            ...
            variant = FlowerMobVariantUtil.getSpawnVariant(this.registryAccess()
                    .registryOrThrow(ModRegistry.CLUCKBLOOM_VARIANT_REGISTRY_KEY), biome, level.getRandom());
    ...
    /**
     * @see net.minecraft.world.entity.animal.MushroomCow#shear(SoundSource)
     */
    @Override
    ...
    public Cluckbloom getBreedOffspring(ServerLevel level, AgeableMob otherParent) {
        Cluckbloom cluckbloom = (Cluckbloom) this.getType().create(level);
        if (cluckbloom != null) {
